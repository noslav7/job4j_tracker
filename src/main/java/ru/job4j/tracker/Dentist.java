...
public class Dentist extends Doctor {
    ...
    public Dentist(String name, String sirname, String education,
                   String birthday, boolean anesthesia) {
    ...
    public static void main(String[] args) {
        Dentist physician = new Dentist("Татьяна", "Полянская",
                "Медицинская академия", "30.06.1965", true);
        physician.getName();
